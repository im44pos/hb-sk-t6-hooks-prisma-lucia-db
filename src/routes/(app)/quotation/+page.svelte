    ...
    <fieldset class="fieldset">
        ...
        <div class="settings">
            ...
            {#if $errors.quotation_item_identifier}
                <br>
	            <small class="error">{$errors.quotation_item_identifier}</small>
            {/if}
            ...
            <select 
                id="valuestream"
                name="valuestream"
                bind:value={selected_valuestream}
            >
                {#each dbvaluestreams as dbvaluestream}
                    <option value={dbvaluestream}>
                        {dbvaluestream.valuestream_name}
                    </option>
                {/each}
            </select> -->
